      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center  gap-4">
          {logos.map((src, i) => (
            <div
              key={i}
              className="w-20 h-20 rounded-full overflow-hidden border border-gray-300 flex items-center justify-center grayscale hover:grayscale-0 transition duration-300 bg-white"
            >
              <img
                src={src}
                alt={`Client ${i + 1}`}
